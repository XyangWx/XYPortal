...
[DependsOn(
    ...
    typeof(XYPortalWebModule),
    typeof(XYPortalApplicationTestModule),
    typeof(XYPortalEntityFrameworkCoreTestModule)
)]
public class XYPortalWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<IMvcBuilder>(builder =>
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(XYPortalWebModule).Assembly));
        });
