...
using XYPortal.Blazor.WebApp.Tiered.Client;
using XYPortal.Blazor.WebApp.Tiered.Client.Menus;
using XYPortal.Blazor.WebApp.Tiered.Components;
using XYPortal.Blazor.WebApp.Tiered.Menus;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/XYPortal.Blazor.WebApp.Tiered.Client.styles.css", true));
                }
            );
        });
    }
