...
using XYPortal.Blazor.Server.Tiered.Components;
using XYPortal.Blazor.Server.Tiered.Menus;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/XYPortal.Blazor.Server.Tiered.styles.css", true));
                }
            );
        });
    }
